...
router.post('/itemLoans', GMPanelController.getItemLoans);
router.post('/itemLoans/items', GMPanelController.getLoanItems);
router.post('/itemLoans/grant', GMPanelController.grantItemLoans);
router.post('/itemLoans/return', GMPanelController.returnItemLoan);
